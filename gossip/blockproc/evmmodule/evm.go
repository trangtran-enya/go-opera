...
func (p *EVMModule) Start(block iblockproc.BlockCtx, statedb evmcore.StateDB, reader evmcore.DummyChain, onNewLog func(*types.Log), net opera.Rules) blockproc.EVMProcessor {
...
func (p *OperaEVMProcessor) Execute(txs types.Transactions, internal bool) types.Receipts {
	...
	receipts, _, skipped, err := evmProcessor.Process(evmBlock, p.statedb, opera.DefaultVMConfig, &p.gasUsed, internal, func(l *types.Log, _ evmcore.StateDB) {
